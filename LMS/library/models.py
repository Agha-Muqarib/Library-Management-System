...
class Book_Issue(models.Model):
    ...
    remarks_on_issue = models.CharField(max_length=100, default="Some Remarks", help_text="Book remarks/condition during issue")
    remarks_on_return = models.CharField(max_length=100, default="Some Remarks", help_text="Book remarks/condition during return")
